...
class PluginConfigsPartialUpdatePathParams:
    id: int = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    project_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'project_id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class PluginConfigsPartialUpdateRequests:
...
@dataclasses.dataclass
class PluginConfigsPartialUpdateRequest:
    path_params: PluginConfigsPartialUpdatePathParams = dataclasses.field()
    request: Optional[PluginConfigsPartialUpdateRequests] = dataclasses.field(default=None)
    

@dataclasses.dataclass
class PluginConfigsPartialUpdateResponse:
