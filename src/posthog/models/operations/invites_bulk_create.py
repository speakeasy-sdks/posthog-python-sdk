...
class InvitesBulkCreatePathParams:
...
@dataclasses.dataclass
class InvitesBulkCreateRequests:
...
@dataclasses.dataclass
class InvitesBulkCreateRequest:
    path_params: InvitesBulkCreatePathParams = dataclasses.field()
    request: InvitesBulkCreateRequests = dataclasses.field()
    

@dataclasses.dataclass
class InvitesBulkCreateResponse:
