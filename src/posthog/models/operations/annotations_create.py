...
class AnnotationsCreatePathParams:
    project_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'project_id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class AnnotationsCreateRequests:
...
@dataclasses.dataclass
class AnnotationsCreateRequest:
    path_params: AnnotationsCreatePathParams = dataclasses.field()
    request: Optional[AnnotationsCreateRequests] = dataclasses.field(default=None)
    

@dataclasses.dataclass
class AnnotationsCreateResponse:
