...
class PaginatedAnnotationList:
    ...
    results: Optional[list[shared_annotation.Annotation]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results'), 'exclude': lambda f: f is None }})
