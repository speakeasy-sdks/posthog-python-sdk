...
class PaginatedFeatureFlagList:
    ...
    results: Optional[list[shared_featureflag.FeatureFlag]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results'), 'exclude': lambda f: f is None }})
