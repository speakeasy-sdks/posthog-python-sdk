...
class PaginatedEventDefinitionList:
    ...
    results: Optional[list[shared_eventdefinition.EventDefinition]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results'), 'exclude': lambda f: f is None }})
