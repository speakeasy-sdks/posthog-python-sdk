...
class PatchedTeamInput:
    ...
    timezone: Optional[PatchedTeamTimezoneEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('timezone'), 'exclude': lambda f: f is None }, 'form': { 'field_name': 'timezone' }, 'multipart_form': { 'field_name': 'timezone' }})
