...
class ActivityLog:
    ...
    detail: Optional[dict[str, Any]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('detail') }})
    is_system: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('is_system') }})
...
class ActivityLogInput:
    ...
    detail: Optional[dict[str, Any]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('detail') }, 'form': { 'field_name': 'detail', 'json': True }, 'multipart_form': { 'field_name': 'detail', 'json': True }})
    is_system: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('is_system') }, 'form': { 'field_name': 'is_system' }, 'multipart_form': { 'field_name': 'is_system' }})
    item_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('item_id') }, 'form': { 'field_name': 'item_id' }, 'multipart_form': { 'field_name': 'item_id' }})
    organization_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('organization_id') }, 'form': { 'field_name': 'organization_id' }, 'multipart_form': { 'field_name': 'organization_id' }})
