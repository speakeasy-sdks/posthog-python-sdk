...
class PaginatedSessionRecordingPlaylistList:
    ...
    results: Optional[list[shared_sessionrecordingplaylist.SessionRecordingPlaylist]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results'), 'exclude': lambda f: f is None }})
