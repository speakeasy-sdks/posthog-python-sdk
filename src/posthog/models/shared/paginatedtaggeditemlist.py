...
import dataclasses
from ..shared import taggeditem as shared_taggeditem
...
class PaginatedTaggedItemList:
    ...
    results: Optional[list[shared_taggeditem.TaggedItem]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results'), 'exclude': lambda f: f is None }})
