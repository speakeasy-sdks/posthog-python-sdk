...
class PaginatedFeatureFlagRoleAccessList:
    ...
    results: Optional[list[shared_featureflagroleaccess.FeatureFlagRoleAccessOutput]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results'), 'exclude': lambda f: f is None }})
