...
class PaginatedInsightList:
    ...
    results: Optional[list[shared_insight.Insight]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results'), 'exclude': lambda f: f is None }})
