...
class PaginatedPluginConfigList:
    ...
    results: Optional[list[shared_pluginconfig.PluginConfig]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results'), 'exclude': lambda f: f is None }})
