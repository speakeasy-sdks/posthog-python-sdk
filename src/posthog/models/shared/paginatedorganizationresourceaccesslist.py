...
class PaginatedOrganizationResourceAccessList:
    ...
    results: Optional[list[shared_organizationresourceaccess.OrganizationResourceAccess]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results'), 'exclude': lambda f: f is None }})
