...
class PaginatedHookList:
    ...
    results: Optional[list[shared_hook.Hook]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results'), 'exclude': lambda f: f is None }})
