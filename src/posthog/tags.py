...
class Tags:
    ...
    def tags_list(self, request: operations.TagsListRequest) -> operations.TagsListResponse:
        ...
        url = utils.generate_url(base_url, "/api/projects/{project_id}/tags/", request.path_params)
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PaginatedTaggedItemList])
                res.paginated_tagged_item_list = out
